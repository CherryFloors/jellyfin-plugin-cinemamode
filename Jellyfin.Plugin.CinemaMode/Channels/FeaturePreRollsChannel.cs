...
/// Trailers Channel.
/// </summary>
public class FeaturePreRollsChannel : IChannel, IDisableMediaSourceDisplay, ISupportsMediaProbe
{
    private readonly ILogger<FeaturePreRollsChannel> _logger;
    // private readonly Channel _channnelManager;

    /// <summary>
    /// Initializes a new instance of the <see cref="FeaturePreRollsChannel"/> class.
    /// </summary>
    /// <param name="logger">Instance of the <see cref="ILogger{FeaturePreRollsChannel}"/> interface..</param>
    /// <param name="channnelManager">Instance of the <see cref="channnelManager"/>.</param>
    public FeaturePreRollsChannel(ILogger<FeaturePreRollsChannel> logger)
    {
        _logger = logger;
    ...
    /// </summary>
    public string Name { get; } = Plugin.Instance.Configuration.FeaturePreRollsChannelName;
    ...
    public List<MediaSourceInfo> GetChannelItemMediaInfo(string id, CancellationToken cancellationToken)
    {
        ...
        mediaSourceInfo.SupportsProbing = true;
        mediaSourceInfo.EncoderProtocol = MediaProtocol.File;
    ...
    public async Task<ChannelItemResult> GetChannelItems(InternalChannelItemQuery query, CancellationToken cancellationToken)
    {
        ...
        string[] preRolls = System.IO.Directory.GetFiles(Plugin.Instance.Configuration.FeaturePreRollsPath);
